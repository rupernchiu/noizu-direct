        ...
        >
          <div className="px-3 py-3 border-b border-border space-y-2">
            ...
            <input
              ...
              className="w-full rounded-lg bg-background border border-border px-3 py-1.5 text-xs text-foreground placeholder-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring"
            />
          </div>
