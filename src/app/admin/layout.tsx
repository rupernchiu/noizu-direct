...
import { LayoutDashboard, Users, Package, ShoppingBag, DollarSign, FileText, Megaphone, Settings, Image } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#0d0d12]">
      <div className="max-w-screen-2xl mx-auto px-4 py-6">
        <div className="mb-4 flex items-center gap-3">
          <span className="px-2 py-0.5 rounded bg-[#ef4444]/20 text-[#ef4444] text-xs font-bold">ADMIN</span>
          <h1 className="text-xl font-bold text-[#f0f0f5]">NOIZU-DIRECT Admin</h1>
        </div>
