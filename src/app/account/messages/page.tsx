  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-[#8888aa] mt-1">Chat with creators</p>
      </div>
            ...
            {conversations.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-xs text-[#8888aa] mt-1">
                  Purchase from a creator to start chatting.
                </p>
              </div>
            ) : (
              conversations.map((convo) => {
                const displayName =
                  convo.creator.creatorProfile?.displayName ??
                  convo.creator.name
                        ...
                        >
                          ...
                          <p
                            className={`text-xs mt-1 ${
                              isMine ? 'text-white/60' : 'text-[#8888aa]'
                            }`}
                          >
