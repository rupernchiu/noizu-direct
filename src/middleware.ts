...
function buildCsp(nonce: string): string {
  const directives = [
    ...
    "img-src 'self' blob: data: https://*.r2.dev https://*.r2.cloudflarestorage.com https://images.unsplash.com https://picsum.photos https://fastly.picsum.photos https://i.ytimg.com https://img.youtube.com https://*.airwallex.com https://c.clarity.ms https://c.bing.com",
    ...
    "frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com https://*.airwallex.com",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
