...
<reference>
@C:/Users/ruper/noizu-direct/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/ruper/noizu-direct/.claude/get-shit-done/references/user-profiling.md` to load:
